    ...
    <section className="container mx-auto px-4 py-16">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="relative h-120 bg-black rounded-lg overflow-hidden flex items-end p-8 md:col-span-2">
            <img
              src="/woman.png"
          ...
          <div className="relative  bg-black rounded-lg overflow-hidden flex items-end p-8">
            <img
              src="/smallspkr.png"
              alt="Speakers"
              className="absolute inset-0 object-cover opacity-80 ml-19 mt-14"
            />
            <div className="relative z-10 text-white">
          ...
          <div className="relative h-94 bg-black rounded-lg overflow-hidden flex items-end p-8">
            <img
              src="/perfume.png"
              alt="Perfume"
              className="absolute inset-0 object-cover opacity-80 ml-19 mt-14"
