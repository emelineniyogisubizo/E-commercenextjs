...
export function FlashSales() {
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12 ml-38">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-76 mb-8">
                {getCurrentProducts().map((product) => (
                    <div key={product.id} className="group cursor-pointer">
                        <div className="relative bg-gray-200 rounded-sm p-8 mb-4 w-85 h-74 flex items-center justify-center">
                            ...
                            <div className="w-52 h-32 rounded-lg flex items-center justify-center overflow-hidden">
                                <Image
                                    src={product.image}
                                    alt={product.name}
                                    width={200}
            ...
            <div className="flex justify-center gap-3 mb-8 ml-50 mt-30">
